...
import com.leyi.refactor.firstcase.*;
...
class RefactorApplicationTests {
    ...
    private static void regularTest() {
        Movie movie = Movie.builder().title("重构 改善既有代码的设计").price(new RegularPrice()).build();
    ...
    private static void childrenTest() {
        Movie movie = Movie.builder().title("重构 改善既有代码的设计").price(new ChildrenPrice()).build();
